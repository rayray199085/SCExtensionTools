...
- (UIButton *)makeButton:(NSString *) title andIndex:(int)index{
    ...
    NSDictionary * dict = @{NSFontAttributeName:[UIFont systemFontOfSize:13.0f]};
    float padding = (width - (_image.size.width + [title sizeWithAttributes:dict].width)) / 2;
    ...
    [button setImageEdgeInsets:UIEdgeInsetsMake(11, [title sizeWithAttributes:dict].width + padding + 5, 11, 0)];
